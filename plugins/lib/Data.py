class datapoints:
	...
	class age:
		...
		class date_of_birth:
			date_of_birth = "dp.age.date_of_birth.date_of_birth"
			day = "dp.age.date_of_birth.day"
			month = "dp.age.date_of_birth.month"
			year = "dp.age.date_of_birth.year"
	class person:
		ethnicity = "dp.person.ethnicity"
		nationality = "dp.person.nationality"
	class body:
		height = "dp.body.height"
		weight = "dp.body.weight"
		eye_color = "dp.body.eye_color"
		skin_color = "dp.body.skin_color"
		hair_color = "dp.body.hair_color"
		gender = "dp.body.gender"
	class education:
