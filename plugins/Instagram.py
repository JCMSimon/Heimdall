...
class Instagram(Plugin):                # Class Name must be the same as the File Name
	...
	def run(self,arg) -> list:
		testResult = Node("instagram Username",debug=self.debug)
		testResult.addDataField(dp.username.instagram,"JCMS")
		# return [testResult]